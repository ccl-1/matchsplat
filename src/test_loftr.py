...
def run(cfg_dict: DictConfig):
    ...
    depth_ckpt_path = "checkpoints/epoch_256-step_10k.ckpt"
    ...
    # save_image(batch["context"]["image"][0, 0], f"outputs/tmp/depth/input_0.png")
    # save_image(batch["context"]["image"][0, 1], f"outputs/tmp/depth/input_1.png")
