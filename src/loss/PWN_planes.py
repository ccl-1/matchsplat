...
class PWNPlanesLoss(nn.Module):
    ...
    def __init__(self, delta_cos=0.867, delta_diff_x=0.007,
                 delta_diff_y=0.007, sample_groups=5000, loss_weight=1.0, **kwargs):
        """
...
if __name__ == '__main__':
    ...
    mask = torch.ones_like(gt_depth, dtype=torch.uint8)
    ...
    loss = vnl_loss(pred_depth, gt_depth, mask, intrins)
    print(loss)
